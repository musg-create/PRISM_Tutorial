...
Tutorial 5.1 uses repository-supplied landmark coordinate pairs selected through [MAGPIE's interactive landmark-selection tool](https://core-bioinformatics.github.io/magpie/shiny-app/shiny-app.html). These PRISM-authored supplementary coordinates contain no RNA or MSI measurements. Tutorials 6.1 and 7.1 begin after GLUE preparation; no standalone GLUE preparation workflow or precomputed embeddings are provided here. See the [SLAT installation guide](https://slat.readthedocs.io/) for the required environment setup.
